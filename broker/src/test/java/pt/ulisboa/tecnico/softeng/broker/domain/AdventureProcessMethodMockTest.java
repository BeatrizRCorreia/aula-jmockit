...
public class AdventureProcessMethodMockTest {
	...
	@Test
	public void processWithBankExpections(@Mocked final BankInterface bankInterface,
			@Mocked final HotelInterface hotelInterface, @Mocked final ActivityInterface activityInterface) {
		new Expectations() {
			{
				BankInterface.processPayment(IBAN, 300);
				this.result = new BankException("Bank exception !!!");
			}
		};
	...
	@Test
	public void processWithHotelExpections(@Mocked final BankInterface bankInterface,
			@Mocked final HotelInterface hotelInterface, @Mocked final ActivityInterface activityInterface) {
		new Expectations() {
			{
				BankInterface.processPayment(IBAN, 300);
				...
				HotelInterface.reserveHotel(Type.SINGLE, AdventureProcessMethodMockTest.this.begin,
						AdventureProcessMethodMockTest.this.end);
				this.result = new HotelException("Hotel exception !!!");
			}
		};
	...
	@Test
	public void processWithActivityExpections(@Mocked final BankInterface bankInterface,
			@Mocked final HotelInterface hotelInterface, @Mocked final ActivityInterface activityInterface) {
		new Expectations() {
			{
				BankInterface.processPayment(IBAN, 300);
				...
				ActivityInterface.reserveActivity(AdventureProcessMethodMockTest.this.begin,
						AdventureProcessMethodMockTest.this.end, 20);
				this.result = new ActivityException("Activity exception !!!");
			}
		};
